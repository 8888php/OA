                    ...
                    <table class="table  table-condensed" style="table-layout: fixed;text-align: center;border-color:#000;" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td >流水单号</td>
                                <td colspan='3'> <input  type="text" class="oddnum" name="oddnum"  style='height:25px;width:180px;'  value="<?php echo date('Ym');?>">  </select> 
                                </td>
                            </tr>
                             ...
                             <tr>
                                <td>使用内容</td>
                                <td colspan='6'>   
                                    <input type="checkbox" class="sealtype" name="sealtype" value='1' />  公章
                                    <input type="checkbox" class="sealtype" name="sealtype" value='2' />  名章
                                </td>
                             </tr>
                             <tr>
                                <td> 文件类型 </td>
                                <td colspan='6' >  
                                    <input type='radio'class="filetype" name='filetype' value='1' > 报表   
                                    <input type='radio'class="filetype" name='filetype' value='2' > 合同、协议  
                                    <input type='radio'class="filetype" name='filetype' value='3' > 证明  
                                    <input type='radio'class="filetype" name='filetype' value='4' > 申请  
                                    <input type='radio'class="filetype" name='filetype' value='5' > 介绍信  
                                    <input type='radio'class="filetype" name='filetype' value='6' > 外部函件  
                                    <input type='radio'class="filetype" name='filetype' value='7' > 其他  
                                </td>
                             </tr>                           
                            <tr>
                                <td >文号/编号</td>
