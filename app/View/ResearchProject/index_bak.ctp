                            ...
                            <div class="tab-content no-border ">
                                <div id="faq-tab-1" class="tab-pane fade in active">
                                    ...
                                    <table class="table table-striped table-bordered table-condensed" >
                                        ...
                                        <div class="modal fade" id="modal_addmember" tabindex="-1" role="dialog" aria-labelledby="modal" style='width:670px;height:408px;margin:8% auto 0px; overflow: hidden;border-radius:4px; overflow-y:auto;'>
                                            <button type="button" class="close" id="addmember_close" data-dismiss="modal" aria-hidden="true"></button>
                                            <iframe id="iframe_1" src="/ResearchProject/add_member/<?php echo $pid;?>" style="width:660px;min-height:400px;border-radius:4px; "  frameborder="0"> </iframe>
                                        </div>
