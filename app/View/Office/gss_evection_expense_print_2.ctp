        ...
        <div class="tab-content no-border ">
            <div id="faq-tab-1" class="tab-pane fade in active">
                <form class="form-horizontal" role="form">
                    <table class="table  table-condensed" style="table-layout: fixed;text-align: center;border-color:#000;margin-bottom:0px" >
                    ...
                    <table class="table  table-condensed" style="table-layout: fixed;text-align: center;border-color:#000;margin-bottom:0px" >
                        <tbody>
                            <tr>
                                <td >填表时间</td>
                                <td >  <?php echo $attr_arr[0][$table_name]['ctime'];?>  </td>
                                <td>附单据张数</td>
                    ...
                    <table class="table  table-condensed" style="table-layout: fixed;text-align: center;border-color:#000;margin-bottom:0px" >
                        <tbody>
                            <tr>
                                <td>起止日期</td>
                                <td>起讫地点</td>
                                <td style="width: 70px">车船费</td>
                                <td style="width: 70px">差旅补助天数</td>
                                <td style="width: 70px">差旅补助标准</td>
                                <td style="width: 70px">差旅补助金额</td>
                                <td style="width: 70px">住宿费</td>
                                <td style="width: 70px">其他费用</td>
                            </tr>
                            <?php 
                    ...
                    <table class="table  table-condensed" style="table-layout: fixed;text-align: center;border-color:#000;margin-bottom:0px" >
                        <tbody>
                            <tr>
                                <td style="width:80px;">事由</td>
                                <td > <?php echo $attr_arr[0][$table_name]['reason'];?> </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table  table-condensed" style="table-layout: fixed;text-align: center;border-color:#000;" >
                        <tbody>
                            <tr>
                                <td colspan='2' style="width:100px;" >申报人</td>
                                <td  style="">项目负责人</td>
                                <td >科室负责人</td>
                                <td  style="" >分管所领导</td>
                                <td  style="">所长</td>
