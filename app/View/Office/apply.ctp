                    ...
                    <div class="row">
						...
						?>
                                                <tr>
                                                    ...
                                                    <?php   } ?>
                                                          <?php if (($sv['ApplyMain']['code'] == 0 || ($sv['ApplyMain']['code'] != 10000 && !(new OfficeController())->has_approval_information($sv['ApplyMain']['id']))) && in_array($sv['ApplyMain']['table_name'], array('apply_baoxiaohuizong', 'apply_jiekuandan', 'apply_lingkuandan', 'apply_chuchai_bxd', 'apply_request_report', 'apply_caigou'))) {?>
