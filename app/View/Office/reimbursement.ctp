                ...
                <div class="page-content">						
                    <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table  class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo $sv['ApplyMain']['attr_id'];  ?></td>
                                                    <td><?php echo $sv['ApplyMain']['name'] . $sv['ApplyMain']['attr_id'];  ?></td>

                                                    <td><?php echo $sv['ApplyMain']['ctime'];  ?></td>
                                                    <td><?php echo Configure::read('code_bxd_arr')[$sv['ApplyMain']['code']];  ?></td>
                        ...
                        <div class="modal-footer no-margin-top">
                            <?php echo $this->Page->show($limit, $total, $curpage, 1, "/office/reimbursement/",5 ); ?>                                        
                        </div>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
...
<script type="text/javascript">
    show_left_select('office', 'wait_approval_reimbursement');
</script>