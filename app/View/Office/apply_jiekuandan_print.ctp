                ...
                <form class="form-horizontal" role="form">
                    <table class="table  table-condensed" style="/*table-layout: fixed;*/text-align: center;border-color:#000;" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 20%; height: 40px;">填表日期</td>
                                <td colspan='6'>  <?php echo $attr_arr[0][$table_name]['ctime'];?>  </td>
                            </tr>
                            
                             <tr>
                                <td style="height: 40px;">部门或项目</td>
                                <td colspan='4'>  
                                ...
                                <td style="width: 70px;"> <?php echo $user_arr['User']['name'];?> </td>
                            </tr>
                            ...
                            <tr style="display: none;">
                                <td style="width: 30%;" colspan="2">团队/科室<br/>负责人审核</td>
                                <td style="width: 15%;">分管领导审核</td>
                                <td style="width: 16%;">分管财务<br/>领导审核</td>
