                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                        <a data-toggle="modal" data-remote='true'   data-target="#modal_wait" href="#" style="text-decoration:none;" onclick="$('#modal-body').load('/department/add/<?php echo $v['dep']['id']; ?>');"  >
                                ...
                                <div class="modal-footer no-margin-top">
                                    <button class="btn btn-sm btn-info pull-left" data-toggle="modal" data-remote='true'   data-target="#modal_wait" href="#" onclick="$('#modal-body').load('/department/add');"  >
                                        <i class="icon-plus"></i>
                                        添加部门
                                    </button>
