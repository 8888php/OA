...
Configure::write('applylist', array(
    ...
    '财务科申请单下载' => array('劳务费汇总表、劳务用工原始记录表' => '/downfile/laowuhuizongbaoxiaodan.xls', '专家评审验收费领款表' => '/downfile/zhuanjiapingshenfei.xls', '专家授课费领款表' => '/downfile/zhuanjiashoukefei.xls', '专家咨询费领款表' => '/downfile/zhuanjiazixunfei.xls', '示范基地（所区外）材料使用表' => '/downfile/cailiaoshiyong.xls', '原始票据报销 粘贴单' => '/downfile/piaojvbaoxiao.doc', '会议培训 预决算表' => '/downfile/huiyipeixun.doc', '物资采购合同模板' => '/downfile/wuzicaigou.docx', '询价单' => '/downfile/xunjiadan.doc',
		'询价汇总单' => '/downfile/xunjiahuizongdan.doc', /*'果树研究所预算调整申请表' => '/downfile/guoshuyanjiusuoyusuantiaozheng.doc',*/ '预算调整申请表' => '/downfile/yusuantiaozhengshenqingbiao.doc',
		'（科研活动费等科目）预算调整申请表' => '/downfile/keyanhuodongfeiyusuantiaozheng.doc',
		),
...
Configure::write('approval_process',array(
    ...
    'apply_received' => array(
        1 => '15,6,29,30,31,32,33,34',   // 来文批办单 所办 15所办主任
        2 => '15,29,6,30,31,32,33,34',   // 来文批办单 党办 15党办主任，5党办副所长
    ),
    ...
    'apply_request_report' => array( // 请示报告卡片
         ...
         */
        // 2019年开始 采用新审批流
        1 => '11,5',// 科研项目  如项目有所属项目组，增加项目组负责人审批 2项目组负责人， 5是科研部门副所长
        2 => '15', // 行政部门
    ),
));
